...
class PickleStorageService(StorageService):
    ...
    Example:
    - path = /tmp/test/
    storage['hello'] = 'world'    # > /tmp/test/hello.storage.pkl (Create)
    storage['hello'] = 'country'  # > /tmp/test/hello.storage.pkl (Override)
    storage['my'] = 'data'        # > /tmp/test/my.storage.pkl (Create)
